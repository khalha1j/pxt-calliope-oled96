...
namespace oled96 {
    ...
    function putChar(c: string) {
        ...
        {
            if(c1 < 32){
                writeCustomChar(basicFont[25]);//writeCustomChar("\x00\xFF\x81\x81\x81\xFF\x00\x00");
            }
            if(c1 > 1000){
                writeCustomChar(basicFont[10]);//writeCustomChar("\x00\xFF\x81\x81\x81\xFF\x00\x00");
            }
            if(c1 > 500 && c1 < 1000){
                writeCustomChar(basicFont[15]);//writeCustomChar("\x00\xFF\x81\x81\x81\xFF\x00\x00");
            }
             if(c1 > 127 && c1 < 500){
                writeCustomChar(basicFont[20]);//writeCustomChar("\x00\xFF\x81\x81\x81\xFF\x00\x00");
             }
...
const basicFont: string[] = [
    ...
    "\x00\x00\x5F\x00\x00\x00\x00\x00", // "!"  1
    "\x00\x00\x07\x00\x07\x00\x00\x00", // """  2
    "\x00\x14\x7F\x14\x7F\x14\x00\x00", // "#"  3
    "\x00\x24\x2A\x7F\x2A\x12\x00\x00", // "$"  4
    "\x00\x23\x13\x08\x64\x62\x00\x00", // "%"  5
    "\x00\x36\x49\x55\x22\x50\x00\x00", // "&"  6
    "\x00\x00\x05\x03\x00\x00\x00\x00", // "'"  7
    "\x00\x1C\x22\x41\x00\x00\x00\x00", // "("  8
    "\x00\x41\x22\x1C\x00\x00\x00\x00", // ")"  9
    "\x00\x08\x2A\x1C\x2A\x08\x00\x00", // "*"  10
    ...
    "\x00\x20\x10\x08\x04\x02\x00\x00", // "/"  15
    "\x00\x3E\x51\x49\x45\x3E\x00\x00", // "0"  16  = 48 -32
    "\x00\x00\x42\x7F\x40\x00\x00\x00", // "1"  17
    "\x00\x62\x51\x49\x49\x46\x00\x00", // "2"  18
    "\x00\x22\x41\x49\x49\x36\x00\x00", // "3"  19
    "\x00\x18\x14\x12\x7F\x10\x00\x00", // "4"  20
    ...
    "\x00\x06\x49\x49\x29\x1E\x00\x00", // "9"  25
    ...
    "\x00\x3E\x41\x41\x41\x22\x00\x00", // "C"  35
    ...
    "\x00\x7F\x08\x08\x08\x7F\x00\x00", // "H"  40
    ...
    "\x00\x7F\x09\x19\x29\x46\x00\x00", // "R"  50
